    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <!-- 处理默认图片 -->
            <img v-imageerror="defaultImage" :src="avatar">
          </div>
...
export default {
  ...
  created() {
    ...
    this.currentH = this.startDate.getHours()
    this.currentM = this.startDate.getMinutes()
    this.currentS = this.startDate.getSeconds()
  }
}
</script>
